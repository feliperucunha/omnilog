export const LOG_CARD_IMAGE_COLUMN =
  "relative w-28 shrink-0 self-stretch overflow-hidden min-h-[7rem] sm:w-[6.4rem] sm:min-h-0";

export const LOG_CARD_IMAGE_COLUMN_ROUNDED_L =
  `${LOG_CARD_IMAGE_COLUMN} rounded-l-lg`;
...
export const LOG_CARD_HEIGHT_FEED_COLLAPSED = "min-h-[160px] h-[160px] sm:min-h-[128px] sm:h-[128px]";

export const LOG_CARD_HEIGHT_FEED_EXPANDED = "min-h-[140px] sm:min-h-[112px]";

export const LOG_CARD_BODY_PADDING = "p-3 sm:p-3";

export const LOG_CARD_BODY_GAP = "gap-1.5 sm:gap-1";

export const LOG_CARD_TITLE = "text-sm font-semibold sm:text-sm";
...
export const RECOMMENDATION_CARD_BODY = "flex min-h-[3.5rem] w-full flex-col gap-0.5 p-2.5 sm:min-h-[2.8rem] sm:p-2";
